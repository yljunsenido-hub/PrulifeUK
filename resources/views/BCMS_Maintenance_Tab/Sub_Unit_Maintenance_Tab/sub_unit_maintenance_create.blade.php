...
<head>
    ...
    <title>Create New Subunit</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
</head>
<body class="bg-gray-100">
    <div class="container mx-auto mt-10">
        <h1 class="text-xl font-bold mb-4">Subunit Maintenance / Create New Subunit</h1>
        <div class="bg-white p-6 rounded-lg shadow-md">
            <form action="/create-subunit" method="POST">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700" for="subunit-name">Subunit Name</label>
                ...
                <div class="flex justify-between mt-6">
                    <button type="submit" class="px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600">Create New Subunit</button>
                    <button type="button" onclick="window.location.href='/subunit-maintenance'" class="px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600">Back</button>
                </div>
            </form>
        </div>
    </div>
