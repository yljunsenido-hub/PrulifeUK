...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <h1 class="pl-2 text-l text-yellow-300 font-semibold "><a href="#" id="createNewAgent" class="text-base xl:text-yellow-300 hover:text-yellow-100 font-semibold">Create New Poster </a></h1>
</div>
