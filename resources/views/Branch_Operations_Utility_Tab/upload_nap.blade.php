...
<div id="main-content" class="content">
    <div class="container mx-auto max-w-3xl bg-white p-4 rounded-lg shadow-md">
        ...
        <div class="space-y-6 mt-5">
            ...
            <!-- File input and Date Range Text -->
            <div class="flex flex-col md:flex-row justify-between items-center md:space-x-4 w-full">

                <!-- File input -->
                <input type="file" id="file-upload" class="border border-gray-300 p-3 rounded-md w-full md:w-auto focus:outline-none focus:ring-2 focus:ring-blue-500 text-center">

                <!-- Date Range Text -->
                <p class="text-gray-700 text-sm text-right md:text-right mt-4 md:mt-0">
