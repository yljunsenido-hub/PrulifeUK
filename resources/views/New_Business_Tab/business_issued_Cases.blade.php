...
<head>
    ...
    <title>Business Issued Cases</title>
                ...
                <table class="min-w-full bg-white border border-gray-300 text-sm">
                    <thead>
                        <tr class="bg-blue-200 text-gray-600">
                            ...
                            <th class="py-2 px-4 text-left border-r border-gray-300 w-1/4">Sub-unit No.</th>
                            ...
                            <th class="py-2 px-4 text-left border-r border-gray-300 w-1/4">APE</th>
                             <th class="py-2 px-4 text-left border-r border-gray-300 w-1/4">Issued Date</th>
