...
<body>
    ...
    <div id="main-content" class="content">
        ...
        <div class="bg-white p-3 rounded-lg shadow-lg flex-1 border-2 border-slate-500 mb-5">
            ...
            <div class="flex items-center mb-4">
                <label for="client-age" class="block text-md font-medium text-gray-700 w-1/4">Age</label>
            ...
            <div class="flex items-center mb-4">
                <label for="min-budget" class="block text-md font-medium text-gray-700 w-1/4">Minimum Budget</label>
                <input type="text" id="min-budget" placeholder="Minimum Budget" class="mt-1 block w-2/3 border border-gray-300 rounded-md p-2" />
            </div>
                
            <div class="flex items-center mb-4">
                <label for="max-budget" class="block text-md font-medium text-gray-700 w-1/4">Maximum Budget</label>
