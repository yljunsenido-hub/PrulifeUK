...
<head>
    ...
    <title>Recruitment Create</title>
...
<body>
	...
	<div class="container mx-auto max-w-9xl bg-white p-6 rounded-lg shadow-md">
        ...
        <h1 class="container mx-auto max-w-9xl bg-blue-900 rounded-lg rounded-md shadow-md mb-3">
            <div class="flex items-center">

                <a href="{{ route('recmaintenance') }}" class="text-md text-gray-300 block p-2">
                <p class="text-yellow-300 hover:underline hover:text-white ml-1">Recruitment Maintenance</p></a>
