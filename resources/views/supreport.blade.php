...
<head>
    ...
    <title>Sub-Unit Production Report</title>
</head>
<body class="bg-gray-100 p-6 border border-gray-300">
    <div class="container mx-auto max-w-8xl bg-white p-6 rounded-lg shadow-md">
        <h2 class="text-2xl font-semibold mb-4">Sub-Unit Production Report</h2>
        
        <div class="mb-4 flex justify-center space-x-2 items-center">
        <select id="entries" class="border border-gray-300 rounded-md p-2 w-80">
...
<div class="flex justify-center items-center mt-4 space-x-2">
    ...
    <div class="flex items-center space-x-2">
        <span class="mr-1 text-xs text-gray-600"></span>
